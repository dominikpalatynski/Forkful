...
test.describe("Create Recipe Flow", () => {
  test("should successfully create a new recipe", async ({ page, baseURL }) => {
    ...
    await step2Input.pressSequentially("Wymieszaj makaron z pancett i |�Btkami, dodaj parmezan i pieprz.", {
      delay: 30,
    });
    ...
    await expect(page.getByText("Wymieszaj makaron z pancett i |�Btkami, dodaj parmezan i pieprz.")).toBeVisible();
