      ...
      <div className="container">
        <div className="flex flex-col gap-5">
          <div className="relative flex flex-col gap-5">
            ...
            <h2 className="mx-auto max-w-5xl text-balance text-center text-3xl font-medium md:text-6xl">{heading}</h2>
            <p className="text-muted-foreground mx-auto max-w-3xl text-center md:text-lg">{description}</p>
            <div className="flex flex-col items-center justify-center gap-3 pb-12 pt-3">
              ...
              {trustText && <div className="text-muted-foreground text-xs">{trustText}</div>}
            </div>
          </div>
          <img
            src={imageSrc}
