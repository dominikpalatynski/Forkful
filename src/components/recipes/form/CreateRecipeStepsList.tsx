 ...
 *
 * Manages a dynamic list of recipe preparation steps with add/remove functionality for new recipe creation.
 * Uses useFieldArray from react-hook-form to handle array operations.
 * Each step uses a Textarea for longer text content.
 * This is a separate component from EditableStepsList because it uses CreateRecipeCommand
