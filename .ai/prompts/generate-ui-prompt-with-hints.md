...
1. Dla każdej sekcji wejściowej (Hints, PRD, User Stories, Endpoint Description, Endpoint Implementation, Type Definitions, Tech Stack):

- Podsumuj kluczowe punkty
- Wymień wszelkie wymagania lub ograniczenia
- Zwróć uwagę na wszelkie potencjalne wyzwania lub ważne kwestie

2. Wyodrębnienie i wypisanie kluczowych wymagań z PRD oraz Hints
3. Wypisanie wszystkich potrzebnych głównych komponentów, wraz z krótkim opisem ich opisu, potrzebnych typów, obsługiwanych zdarzeń i warunków walidacji
4. Stworzenie wysokopoziomowego diagramu drzewa komponentów
5. Zidentyfikuj wymagane DTO i niestandardowe typy ViewModel dla każdego komponentu widoku. Szczegółowo wyjaśnij te nowe typy, dzieląc ich pola i powiązane typy.
6. Zidentyfikuj potencjalne zmienne stanu i niestandardowe hooki, wyjaśniając ich cel i sposób ich użycia
7. Wymień wymagane wywołania API i odpowiadające im akcje frontendowe
8. Zapoznaj się z <rules> pod kontem zasad panujących w projekcie
9. Przed wdrozeniem szczegółów implementacji przeprowadź analizę projektu czy jakieś rzeczy nie zostały wcześniej stworzone, np jakiś hook, component. Jeśli tak to uwzględnij to w krokach implementacji.
10. Zmapuj każdej historii użytkownika do konkretnych szczegółów implementacji, komponentów lub funkcji
11. Wymień interakcje użytkownika i ich oczekiwane wyniki
12. Wymień warunki wymagane przez API i jak je weryfikować na poziomie komponentów
13. Zidentyfikuj potencjalne scenariusze błędów i zasugeruj, jak sobie z nimi poradzić
14. Wymień potencjalne wyzwania związane z wdrożeniem tego widoku i zasugeruj możliwe rozwiązania
